...
<div class="tab-content" id="myTabContent">
	...
	<div class="tab-pane fade" id="tab_0" role="tabpanel">
		@include('lara-admin::entity.edit.tabs.tab0_info')
	</div>
	<!-- /.tab-pane -->

	<div class="tab-pane fade" id="tab_1" role="tabpanel">
		@include('lara-admin::entity.edit.tabs.tab1_columns')
	</div>
	<!-- /.tab-pane -->

	<div class="tab-pane fade" id="tab_2" role="tabpanel">
		@include('lara-admin::entity.edit.tabs.tab2_objectrelations')
	</div>
	<!-- /.tab-pane -->

	<div class="tab-pane fade" id="tab_3" role="tabpanel">
		@include('lara-admin::entity.edit.tabs.tab3_filters')
	</div>
	<!-- /.tab-pane -->

	<div class="tab-pane fade" id="tab_4" role="tabpanel">
		@include('lara-admin::entity.edit.tabs.tab4_panels')
	</div>
	<!-- /.tab-pane -->

	<div class="tab-pane fade" id="tab_5" role="tabpanel">
		@include('lara-admin::entity.edit.tabs.tab5_media')
	</div>
	<!-- /.tab-pane -->

	<div class="tab-pane fade" id="tab_6" role="tabpanel">
		@include('lara-admin::entity.edit.tabs.tab6_customcolumns')
	</div>
	<!-- /.tab-pane -->

	<div class="tab-pane fade" id="tab_7" role="tabpanel">
		@include('lara-admin::entity.edit.tabs.tab7_relations')
	</div>
	<!-- /.tab-pane -->

	<div class="tab-pane fade" id="tab_8" role="tabpanel">
		@include('lara-admin::entity.edit.tabs.tab8_views')
	</div>
	<!-- /.tab-pane -->

	<div class="tab-pane fade" id="tab_9" role="tabpanel">
		@include('lara-admin::entity.edit.tabs.tab9_sortable')
	</div>
	<!-- /.tab-pane -->
