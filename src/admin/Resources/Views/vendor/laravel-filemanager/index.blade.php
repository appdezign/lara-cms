...
<div class="container-fluid" id="wrapper">
	<div class="panel panel-primary d-none d-sm-block">
	...
	<div class="row">
		...
		<div class="col-10 col-12" id="main">
			<nav class="navbar navbar-default" id="nav">
				<div class="navbar-header">
					...
					<a class="navbar-brand clickable hide" id="to-previous">
						...
						<span class="d-none d-sm-block">{{ trans('laravel-filemanager::lfm.nav-back') }}</span>
					</a>
					<a class="navbar-brand d-block d-sm-none" href="#">{{ trans('laravel-filemanager::lfm.title-panel') }}</a>
				</div>
			...
			<div class="d-block d-sm-none" id="current_dir"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-sm btn-outline btn-outline-success"
