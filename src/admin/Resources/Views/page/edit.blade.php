						...
						<div class="row">
							<div class="col-12 col-lg-10 offset-lg-1">
								...
								<ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6">
									...
									<li class="nav-item">
										<button class="nav-link js-first-tab" type="button" role="tab"
										        data-bs-toggle="tab"
									...
									@if(in_array($data->object->cgroup, ['page', 'module']))
										...
										@if(in_array($data->object->cgroup, ['page', 'module']))
											@if($data->object->widgets->count())
												<li class="nav-item">
													<button class="nav-link" type="button" role="tab"
													        data-bs-toggle="tab"
													        data-bs-target="#tab_widgets">
														<div class="d-none d-md-block">
															{{ _lanq('lara-admin::default.tab.page_widgets') }}
														</div>
														<div class="d-block d-md-none">
								...
								<div class="tab-content" id="myTabContent">
												...
												<ul class="nav nav-tabs  nav-video-tabs" role="tablist">
													@if($entity->hasVideos())
														<li class="nav-item" role="presentation">
															<button class="nav-link subtabs @if($data->object->videofiles->count() == 0) active @endif"
															        id="home-tab" data-bs-toggle="tab"
															        data-bs-target="#vidembed" type="button" role="tab">
													...
													@if($entity->hasVideoFiles())
														<li class="nav-item" role="presentation">
															<button class="nav-link subtabs @if($data->object->videofiles->count() > 0) active @endif"
															        id="home-tab" data-bs-toggle="tab"
															        data-bs-target="#vidupload" type="button"
															        role="tab">
									...
									@if(in_array($data->object->cgroup, ['page', 'module']))
										@if($data->object->widgets->count())
											<div class="tab-pane fade" id="tab_widgets">
												@include('lara-admin::_partials.larawidgets')
											</div>
										@endif
									@endif
